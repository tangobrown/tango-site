  ...
  return (
    ...
    >
      ...
      <div className="container-tb pt-11">
        <h1
          className="font-heading font-medium text-gold leading-[1.06] tracking-[-0.01em]"
      ...
      <div className="container-tb pt-[88px] pb-[108px] grid grid-cols-1 md:grid-cols-2 gap-20 items-start">
        <div>
          ...
          <h2
            className="font-heading font-medium text-heroText leading-[1.12] tracking-[-0.01em]"
