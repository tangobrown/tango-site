...
export default function Hero() {
  return (
    <section
      id="top"
      className="relative grid grid-cols-1 lg:h-[92vh] lg:min-h-[700px] lg:grid-cols-[48%_minmax(0,1fr)]"
    >
      ...
      <div className="order-2 flex flex-col justify-between gap-14 bg-ink-dark p-[32px_20px_40px] text-cream-text lg:order-1 lg:gap-0 lg:p-[44px_48px_56px]">
        ...
        <div className="flex flex-col gap-7">
          ...
          <p className="m-0 max-w-[48ch] text-[16px] leading-[1.6] text-muted-dark">
