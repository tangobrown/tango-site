          ...
          {work.map((proj, i) => {
            ...
            return (
              <div
                ...
                style={{ top: `${top}px` }}
              >
                <article className="grid grid-cols-1 md:grid-cols-2 md:min-h-[440px] overflow-hidden border border-rule bg-white rounded-br-[35px]">
                  ...
                  <div className="flex flex-col p-6 md:p-10 bg-white text-ink">
                    <div className="font-playfair italic font-medium text-[18px] tracking-[-0.045em] text-muted-faint mb-4">
                      {proj.role}
                    </div>
                    <h3
