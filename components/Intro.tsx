  ...
  return (
    <section className="py-16 lg:pb-[104px] lg:pt-[120px]">
      <div className="mx-auto grid max-w-content grid-cols-1 gap-6 px-5 lg:grid-cols-[1.15fr_1fr] lg:items-start lg:gap-[8vw] lg:px-8">
        <h2 className="m-0 text-pretty font-bebas text-[clamp(30px,3.1vw,46px)] font-normal leading-[1.02] tracking-[0.01em]">
          Most small businesses don&apos;t need an agency. They need one person who understands the
          work and finishes it.
        </h2>
